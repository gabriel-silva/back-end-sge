...
public class ProviderResource {
    ...
    public ResponseEntity<Provider> updateProvider(@PathVariable(value = "id") long id,
        ...
        Provider provider = providerRepository.findById(id).orElseThrow(() -> new NotFoundException("Fornecedor não encontrada com o id :: $id"));
        ...
        Provider responseProvider = providerRepository.save(provider);
        return new ResponseEntity<Provider>(responseProvider, HttpStatus.OK);
    }
